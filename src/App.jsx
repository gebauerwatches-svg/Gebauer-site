        ...
        <div className="story-beat-inner" style={{textAlign: 'center'}}>
          ...
          <div className="invitation-buttons">
            ...
            <button className="story-share" onClick={(e) => {
              if (navigator.share) {
                navigator.share({ title: 'Gebauer Watches', text: '300 watches. Real wood dials. Built from a kitchen table in Colorado. I\'m one of the OGs.', url: 'https://gebauerwatches.com' })
              } else {
