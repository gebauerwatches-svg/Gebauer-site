...
// Small marker icons for the spec blocks. Deliberately simple and small:
// these are markers, not technical illustrations. A simplified drawing blown
// up to 76px just looks like clipart, which is what the first attempt did.
// If Tokiji will supply real part drawings, swap these for those.
const SPEC_ICONS = {
  case:     <><circle cx="12" cy="12" r="6.5"/><path d="M9 5.7V2.5h6v3.2M9 18.3v3.2h6v-3.2M18.5 10.5h2v3h-2"/></>,
  dial:     <><circle cx="12" cy="12" r="9"/><path d="M12 3v2.2M12 18.8V21M3 12h2.2M18.8 12H21"/></>,
  movement: <><path d="M18.6 10.1 L21.3 10.9 L21.3 13.1 L18.6 13.9 L18.0 15.4 L19.4 17.8 L17.8 19.4 L15.4 18.0 L13.9 18.6 L13.1 21.3 L10.9 21.3 L10.1 18.6 L8.6 18.0 L6.2 19.4 L4.6 17.8 L6.0 15.4 L5.4 13.9 L2.7 13.1 L2.7 10.9 L5.4 10.1 L6.0 8.6 L4.6 6.2 L6.2 4.6 L8.6 6.0 L10.1 5.4 L10.9 2.7 L13.1 2.7 L13.9 5.4 L15.4 6.0 L17.8 4.6 L19.4 6.2 L18.0 8.6 Z"/><circle cx="12" cy="12" r="2.7"/></>,
  ...
  glass:    <><path d="M3 9.5h18l-9 11.5z"/><path d="M3 9.5l3.2-5h11.6l3.2 5"/></>,
  caseback: <><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5.5"/><path d="M12 3v1.8M12 19.2V21M3 12h1.8M19.2 12H21"/></>,
  ...
  return (
    <>
      ...
      <section className="hero">
        <img className="hero-img" src={kitchenTable} alt="The table where Gebauer is being built, with tools and sketches" />
      ...
      {/* Specifications. Deliberately AFTER the padauk reveal: the colour
          ...
          interrupted it. Sold first, evidence second. */}
        ...
        <div className="story-beat-inner" style={{textAlign: 'center'}}>
          ...
          <div className="invitation-buttons">
            ...
            <button className="story-share" onClick={(e) => {
              if (navigator.share) {
                navigator.share({ title: 'Gebauer Watches', text: '300 watches. Real wood dials. Built in Colorado. I\'m one of the OGs.', url: 'https://gebauerwatches.com' })
              } else {
