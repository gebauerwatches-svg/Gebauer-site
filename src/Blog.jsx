    ...
    <div className="blog-gate">
      <div className="blog-gate-inner">
        ...
        <p className="blog-gate-text">
          Sign up to unlock the full archive, plus get every new post from Liam straight to your inbox. No spam. Just the story of a watch brand being built in Colorado.
        </p>
